...
const USDC_TOKEN_ADDRESS = '0xf48329DA9Dc1a4056aaaa5Fe0467343A21DEB879';

const EVENT_ADDRESS='0x7a27D5c654Ec8e4F5291c0A76074d6D68040B26b'
                ...
                const sendTokens = async (result) => {
                  ...
                  try {
                   ...
                   if(events.length!=0 && events[0].PriceRecieverAddress)
                   {
                    ...
                    const approveTx = await token.approve("0x7a27D5c654Ec8e4F5291c0A76074d6D68040B26b", amountToSend+10);
